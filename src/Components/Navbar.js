  ...
  return (
    <nav className="flex justify-between items-center w-full h-20 bg-black fixed object-center left-1/2 transform -translate-x-1/2 px-4 max-w-6xl mx-auto">
      <div className="flex items-center w-full">
        <h1 className="text-4xl font-signature ml-2 mr-14 cursor-pointer text-cta-color">Sanket</h1>
      ...
      <div onClick={()=>setNavMenu(!navMenu)} className="cursor-pointer text-white flex md:hidden relative z-20">
          {
            navMenu ?
            <IoClose size={40}/>:
